...
QT_MOC_LITERAL(4, 20, 8), // "progress"
QT_MOC_LITERAL(5, 29, 7) // "percent"

    },
    "worker\0message\0\0str\0progress\0percent"
};
...
void worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&worker::message)) {
                *result = 0;
            }
        }
        {
